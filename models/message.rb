...
class Message
  ...
  def create_message
    ...
    if @button=='Complient appearance'
      @final_message = "From: #{@name}  To: #{@friend} #{@appearance[@number]} (generated by helpinghands.com)"
      return @final_message
    elsif @button=='Praise personality'
      @final_message = "From: #{@name}  To: #{@friend} #{@personality[@number]} (generated by helpinghands.com)" 
      return @final_message
    elsif @button=='Destined for greatness'
      @final_message = "From: #{@name}  To: #{@friend} #{@future[@number]}  (generated by helpinghands.com)"
      return @final_message
    else 
      puts "error"
    end
